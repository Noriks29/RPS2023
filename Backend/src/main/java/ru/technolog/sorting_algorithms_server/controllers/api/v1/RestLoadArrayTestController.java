...
import ru.technolog.sorting_algorithms_server.services.saLoadArrayTestService;
...
@RestController
@RequestMapping("/api/v1/load-array-test")
public class RestLoadArrayTestController {
    // Автоматическое внедрение зависимости сервиса для обработки массивов
    @Autowired
    protected saLoadArrayTestService saLoadArrayService;
    ...
    private ResponseEntity<ApiResponse> deleteArrayByIndex(@RequestParam Long arrayId) {
        return saLoadArrayService.deleteByIdArray(arrayId);
    }
