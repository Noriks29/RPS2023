...
@Entity
@Table(name = "sa_arrays_test")
/*Класс для создания массива как Entity*/
public class saArraysData_test implements IDataEntity {
    @Id
    ...
    public void setArrayData_sort(List<Double> arrayData_sort) {
        this.arrayData_sort = arrayData_sort;
    }
